...
export const UI = {
  en: {
    ...
    extras: 'Desert Extras', extraQuadSingle: 'Quad Biking — Single ATV', extraQuadSingleNote: '€50 / person',
    extraQuadShared: 'Quad Biking — Shared ATV (2 people)', extraQuadSharedNote: '€75 / pair',
    extraBuggy: 'Dune Buggy (up to 2 people)', extraBuggyNote: '€130 / buggy',
  ...
  fr: {
    ...
    extras: 'Extras désert', extraQuadSingle: 'Quad — ATV individuel', extraQuadSingleNote: '50 € / personne',
    extraQuadShared: 'Quad — ATV partagé (2 personnes)', extraQuadSharedNote: '75 € / paire',
    extraBuggy: 'Buggy des dunes (jusqu’à 2 personnes)', extraBuggyNote: '130 € / buggy',
  ...
  es: {
    ...
    extras: 'Extras del desierto', extraQuadSingle: 'Quad — ATV individual', extraQuadSingleNote: '€50 / persona',
    extraQuadShared: 'Quad — ATV compartido (2 personas)', extraQuadSharedNote: '€75 / pareja',
    extraBuggy: 'Buggy de dunas (hasta 2 personas)', extraBuggyNote: '€130 / buggy',
  ...
  it: {
    ...
    extras: 'Extra deserto', extraQuadSingle: 'Quad — ATV singolo', extraQuadSingleNote: '€50 / persona',
    extraQuadShared: 'Quad — ATV condiviso (2 persone)', extraQuadSharedNote: '€75 / coppia',
    extraBuggy: 'Buggy delle dune (fino a 2 persone)', extraBuggyNote: '€130 / buggy',
  ...
  'pt-br': {
    ...
    extras: 'Extras do deserto', extraQuadSingle: 'Quadriciclo — ATV individual', extraQuadSingleNote: '€50 / pessoa',
    extraQuadShared: 'Quadriciclo — ATV compartilhado (2 pessoas)', extraQuadSharedNote: '€75 / dupla',
    extraBuggy: 'Buggy nas dunas (até 2 pessoas)', extraBuggyNote: '€130 / buggy',
